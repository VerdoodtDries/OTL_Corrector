...
## Variables
filename = r"[RSA] Geometrie is consistent met GeometrieArtefact_20240725.xlsx"
...
plot_gdf(gdf_asset, filename='Slagbomen', fanout=True)
...
gdf_asset['notitie'] = 'Oorspronkelijke punten omgevormd naar Polygoon, zoals beschreven in het GA'
