...
gdf_asset['geometry'] = gdf_asset.geometry.buffer(distance=1.0, cap_style='square')
...
gdf_asset['notitie'] = 'Oorspronkelijke puntlocaties zijn gebufferd in overeenstemming met het GeometrieArtefact'
