...
asset_of_interest = 'Energiemeter DNB'


######################################################################
### Print meta_info as the Asset
######################################################################
type_uri = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#EnergiemeterDNB'
...
df_relations_filter = df_relations[
    ...
    #&
    #(df_relations['RelatieObject.doel'].apply(lambda x: x['@type'].endswith('#Laagspanningsaansluiting')))  # doel-asset is Laagspanningsaansluiting
]
