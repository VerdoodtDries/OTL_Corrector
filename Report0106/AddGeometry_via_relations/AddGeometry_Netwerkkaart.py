...
asset_of_interest = 'Netwerkkaart'


######################################################################
### Print meta_info as the Asset
######################################################################
type_uri = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Netwerkkaart'
...
df_relations_filter = df_relations[
    ...
    &
    (df_relations['RelatieObject.doel'].apply(lambda x: x['@type'].endswith('#Netwerkelement')))  # doel-asset is Netwerkelement
]
