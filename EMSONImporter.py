...
class EMSONImporter:
    def __init__(self, request_handler: RequestHandler):
        ...
        self.request_handler.requester.first_part_url += 'emson/'
        self.paging_cursors = {}
    ...
    def get_objects_from_oslo_search_endpoint(self, url_part: str, cursor_name: ResourceEnum = None,
                                              filter_string: str = '{}', size: int = 100) -> [dict]:
        # url = f'core/api/otl/{url_part}/search'  # eminfra
        url = f'api/otl/{url_part}/search' # emson
