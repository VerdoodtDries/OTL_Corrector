...
excel_path = r"C:\Users\DriesVerdoodtNordend\Downloads\[RSA] Geometrie is geldig_ geen opeenvolgende punten_20241016.xlsx"
...
os.makedirs('DA-2024-28289', exist_ok=True)
...
for type_name, items in type_groups.items():
    ...
    filepath = Path(f'DA-2024-28289/{type_name}.geojson')
