...
excel_path = r"C:\Users\DriesVerdoodtNordend\Downloads\[RSA] Geometrie is geldig_ geen opeenvolgende punten_20241021.xlsx"
...
os.makedirs('DA-2024-29171', exist_ok=True)
...
for type_name, items in type_groups.items():
    ...
    filepath = Path(f'DA-2024-29171/{type_name}.geojson')
